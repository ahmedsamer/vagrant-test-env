...
# Official Ubuntu Server 12.04 LTS
  config.vm.define "ubuntu12" do |ubuntu12|
    ...
    ubuntu12.vm.network "forwarded_port", guest: 22, host: 2111, id: "ssh"
...
# Official Ubuntu Server 16.04 LTS
  config.vm.define "ubuntu16" do |ubuntu16|
    ...
    ubuntu16.vm.network "forwarded_port", guest: 22, host: 2333, id: "ssh"
...
# Official CentOSInitial commit Server v6
  config.vm.define "centos6" do |centos6|
    ...
    centos6.vm.network "forwarded_port", guest: 22, host: 2444, id: "ssh"
...
# Official CentOS Server v7
  config.vm.define "centos7" do |centos7|
    ...
    centos7.vm.network "forwarded_port", guest: 22, host: 2555, id: "ssh"
